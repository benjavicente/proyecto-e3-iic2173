...
const ICONPEOPLE = icon({
  iconUrl: "http://assets.stickpng.com/images/587389d8f3a71010b5e8ef4b.png",
  iconSize: [36, 36],
})

const Map = ({ markers }) => {
  console.log(markers);
  const userMarkers = markers.userPositions.map((marker) => {
    return (
  ...
  const peopleMarkers = markers.peoplePositions.map((marker) => {
    return (
